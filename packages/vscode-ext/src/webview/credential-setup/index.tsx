      ...
      {activeTab === 'claude' && (
        <div>
          <p style={{ fontSize: 13, lineHeight: 1.6, marginBottom: 14 }}>
            Sign in to <strong>claude.ai</strong>, then copy your <code>sessionKey</code> cookie
            so we can read your session / weekly usage bars (same data as the website).
          </p>
          <ol style={{ paddingLeft: 18, fontSize: 13, lineHeight: 2.2 }}>
            ...
            <li>Copy the value of <code>sessionKey</code> (starts with <code>sk-ant-sid</code>)</li>
          </ol>
