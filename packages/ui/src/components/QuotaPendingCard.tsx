...
import { ClaudeLogo, CopilotLogo, CodexLogo, CursorLogo, DeepSeekLogo, GeminiLogo, GrokLogo, KimiLogo } from './logos.js';
...
const PENDING_HINTS: Record<ServiceId, string> = {
  ...
  gemini: 'Open gemini.google.com while signed in',
